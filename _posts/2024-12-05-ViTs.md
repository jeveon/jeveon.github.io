...
categories: Paper
excerpt_image: https://en.wikipedia.org/wiki/Vision_transformer#/media/File:Vision_Transformer.png
...
![ViT](https://en.wikipedia.org/wiki/Vision_transformer#/media/File:Vision_Transformer.png)
