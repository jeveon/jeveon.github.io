...
$$\mathcal{L}_gra = \sum_{i,j} \left( \left\| \left|(\hat{I}_t)_{i,j} - (\hat{I}_t)_{i-1,j}\right| - \left|(I_t)_{i,j} - (I_t)_{i-1,j}\right| \right\|_1 + \left\| \left|(\hat{I}_t)_{i,j} - (\hat{I}_t)_{i,j-1}\right| - \left|(I_t)_{i,j} - (I_t)_{i,j-1}\right| \right\|_1 \right) \tag{2}$$
