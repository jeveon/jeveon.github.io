...
categories: Paper
excerpt_image: /assets/images/2026-01-28-DAST/DAST-Net; Dense visual attention augmented spatio-temporal network for unsupervised video anomaly detection-20260128152735883.webp
...
![a](/assets/images/2026-01-28-DAST/DAST-Net; Dense visual attention augmented spatio-temporal network for unsupervised video anomaly detection-20260128152735883.webp)

![a](/assets/images/2026-01-28-DAST/DAST-Net; Dense visual attention augmented spatio-temporal network for unsupervised video anomaly detection-20260128152749650.webp)
...
ResNet과 (c) DenseNet의 차이는 ResNet의 경우 Layer 별 feature를 합산하지만 DenseNet은 feature 특징을 concatenation 한다는 점이다. (|| 은 concatenation operation이다.) 이러한 모델은 더 많은 GPU 메모리를 소비할 수 있지만 학습 및 정확도 측면에서 효율적인 경우가 많다. 
...
![a](/assets/images/2026-01-28-DAST/DAST-Net; Dense visual attention augmented spatio-temporal network for unsupervised video anomaly detection-20260128152806496.webp)
...
![a](/assets/images/2026-01-28-DAST/DAST-Net; Dense visual attention augmented spatio-temporal network for unsupervised video anomaly detection-20260128160119602.webp)

![a](/assets/images/2026-01-28-DAST/DAST-Net; Dense visual attention augmented spatio-temporal network for unsupervised video anomaly detection-20260128161020969.webp)
...
$$\mathcal{L}_{int} = \| I_t - \hat{I}_t \|_2^2\tag{1}$$
여기서 $\hat{I}_t = \mathcal{D}_{\theta_2}(\mathcal{E}_{\theta_1}(I_t))$ 는 모델이 생성한 재구성 프레임이며, $I_t$는 입력값이다. 
...
$$\mathcal{L}_{gra} = \sum_{i,j} \left( \left\| \left|(\hat{I}_t)_{i,j} - (\hat{I}_t)_{i-1,j}\right| - \left|(I_t)_{i,j} - (I_t)_{i-1,j}\right| \right\|_1 + \left\| \left|(\hat{I}_t)_{i,j} - (\hat{I}_t)_{i,j-1}\right| - \left|(I_t)_{i,j} - (I_t)_{i,j-1}\right| \right\|_1 \right) \tag{2}$$

위 두 가지 손실을 가중치($\lambda$)를 적용하여 합친 최종 손실 함수를 구한다. 

$$\mathcal{L} = \lambda_1 \mathcal{L}_{int} + \lambda_2 \mathcal{L}_{gra} \tag{3}$$
...
![a](/assets/images/2026-01-28-DAST/DAST-Net; Dense visual attention augmented spatio-temporal network for unsupervised video anomaly detection-20260128170428257.webp)

![a](/assets/images/2026-01-28-DAST/DAST-Net; Dense visual attention augmented spatio-temporal network for unsupervised video anomaly detection-20260128170448275.webp)

![a](/assets/images/2026-01-28-DAST/DAST-Net; Dense visual attention augmented spatio-temporal network for unsupervised video anomaly detection-20260128170520386.webp)


![a](/assets/images/2026-01-28-DAST/DAST-Net; Dense visual attention augmented spatio-temporal network for unsupervised video anomaly detection-20260128170557728.webp)
![a](/assets/images/2026-01-28-DAST/DAST-Net; Dense visual attention augmented spatio-temporal network for unsupervised video anomaly detection-20260128170622107.webp)

![a](/assets/images/2026-01-28-DAST/DAST-Net; Dense visual attention augmented spatio-temporal network for unsupervised video anomaly detection-20260128170634458.webp)
![a](/assets/images/2026-01-28-DAST/DAST-Net; Dense visual attention augmented spatio-temporal network for unsupervised video anomaly detection-20260128170644726.webp)
